...
public class Realtimebean {
    ...
    public String getCntmsg8() {
        if (ct77 >= 1) {
            cntmsg8 = ct77 + "" + "- Record(s) Found (Funds Release Event - Pattern Match)";
        } else {
    ...
    public String getCntmsg2() {
        if (ct22 >= 1) {
            cntmsg2 = ct22 + "" + "- Record(s) Found  (Bank of Uganda Transfers Event - Pattern Match)";
        } else {
    ...
    public String getCntmsg3() {
        if (ct33 >= 1) {
            cntmsg3 = ct33 + "" + "- Record(s) Found (Account Transfers Event - Pattern Match)";
        } else {
    ...
    public String getCntmsg11() {
        if (ct111 >= 1) {
            cntmsg11 = ct111 + "" + "- Record(s) Found (Emails Event - No Pattern Match)";
        } else {
...
//    private ArrayList<Object> pats11;
    ...
    public String getCn() {
        ...
        try {
            File yourFile = new File("c:\\kriminofiles\\cases.txt");
            if (yourFile.exists()) {
                yourFile.delete();
        }
            writer = new FileWriter("c:\\kriminofiles\\cases.txt");
            //
            int i = 0;
            while ((i == 0) && (csno != null)) {
                writer.append(csno);
        ...
        if (csno == null) {
            ...
            return "Case Number" + " " + csno + " " + " Set for Monitoring";
        }
    }
...
//    }
    ...
    public String getCfile() {
        ...
        try {
            String casepath = "c:\\kriminofiles\\real.txt";
            //
...
// CSV Report Files
                    ...
                    //
                    if (ct66 >= 1) {
                        cntmsg6 = ct66 + "" + "- Record(s) Found  (Phone calls Event - No Pattern Match)";
                    } else {
...
//                        pats.add(tranamt);
                ...
                tpats2 = "BOU Transfers Event" + "(" + "Date" + "|" + "Transaction Type" + "|" + "Debit Amount" + "|" + "Debit Account" + "|" + "Credit Account" + "|" + "Limit Amount" + "|" + "Account Status" + "Bank Authoriser" + ")";
...
//                    String line6;
                ...
                tpats6 = "Telephone Records Event" + "(" + "Dialled No" + " | " + "Date" + " | " + "Caller No" + " | " + "Filename" + ")";
...
//                    //
               ...
               //     bufferedReader.close();
                  ...
                  tpats11 = "Emails Event" + "(" + "Email Date" + " | " + "File Number" + " | "
                                + "Email Reference" + " | "
...
//                }
                ...
                for (int x = 0; x < counter; x++) {
                    ...
                    preface.add(
                            new Paragraph("Analysis Report for Case Number:" + "" + caseNo));
                    preface.add(
